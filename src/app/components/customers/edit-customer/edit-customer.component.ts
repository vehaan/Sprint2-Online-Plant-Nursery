...
export class EditCustomerComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.service.getCustomerByMail(this.email).subscribe((data) => {
      this.customer = data;
  ...
  get g() {
    return (this.editForm.controls.address as FormGroup).controls;
  }
  ...
  onSubmit() {
    ...
    this.service
      .updateCustomer(this.editForm.value.id, this.editForm.value)
      .pipe(first())
      .subscribe(
        (data) => {
          this.customer = data;
