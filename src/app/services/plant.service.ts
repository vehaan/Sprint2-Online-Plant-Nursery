...
export class PlantService {
  ...
  getPlantById(id: number): Observable<Plant> {
    ...
    return <Observable<Plant>>(
      this.http.get(this.baseUrl + '/admin/plant/id/' + id)
    );
  }
  deletePlantById(id: number): Observable<Plant> {
    console.log('in service class');
    return <Observable<Plant>>(
      this.http.delete(this.baseUrl + '/admin/plant/id/' + id)
    );
  }
  updatePlant(plant: Plant): Observable<Plant> {
    return <Observable<Plant>>(
      this.http.put(this.baseUrl + '/admin/plant/id/' + plant.id, plant)
    );
  }
  addPlant(plant: Plant): Observable<Plant> {
    return <Observable<Plant>>(
      this.http.post(this.baseUrl + '/admin/plant', plant)
    );
  }
  ...
  FilterByDifficulty(difficulty: string): Observable<Plant[]> {
    return <Observable<Plant[]>>(
      this.http.get(
        this.baseUrl + '/admin/plants/filterByDifficulty/' + difficulty
      )
    );
  }
  FilterByBloomTime(bloomTime: string): Observable<Plant[]> {
    return <Observable<Plant[]>>(
      this.http.get(
        this.baseUrl + '/admin/plants/filterByBloomTime/' + bloomTime
      )
    );
  }
}
