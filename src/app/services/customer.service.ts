...
export class CustomerService {
  ...
  getAllCustomers(): Observable<Customer[]> {
    return <Observable<Customer[]>>(
      this.http.get(this.baseUrl + '/admin/customers')
    );
  }

  getCustomerById(id: number): Observable<Customer> {
    return <Observable<Customer>>(
      this.http.get(this.baseUrl + '/customers/id/' + id)
    );
  }

  deleteCustomerById(id: number): Observable<Customer> {
    return <Observable<Customer>>(
      this.http.delete(this.baseUrl + '/customers/id/' + id)
    );
  }
  updateCustomer(id: number, customer: Customer): Observable<Customer> {
    return <Observable<Customer>>(
      this.http.put(this.baseUrl + '/customers/id/' + id, customer)
    );
  }

  addCustomer(customer: Customer): Observable<Customer> {
    return <Observable<Customer>>(
      this.http.post(this.baseUrl + '/register', customer)
    );
  }
  ...
  setStatus(id: number): Observable<Customer> {
    return <Observable<Customer>>(
      this.http.get(this.baseUrl + '/customers/toggleStatus/' + id)
    );
  }
  ...
  changePassword(customer: Customer): Observable<Customer> {
    ...
    return <Observable<Customer>>(
      this.http.post(this.baseUrl + '/customers/resetPassword', customer)
    );
  }
}
