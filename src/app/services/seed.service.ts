...
export class SeedService {
  ...
  FilterByBloomTime(bloomTime: string) {
    return <Observable<Seed[]>>(
      this.http.get(
        this.baseUrl + '/admin/seeds/filterbybloomtime/' + bloomTime
      )
    );
  }
  FilterByDifficulty(difficulty: string) {
    return <Observable<Seed[]>>(
      this.http.get(
        this.baseUrl + '/admin/seeds/filterbydifficulty/' + difficulty
      )
    );
  }
  ...
  getSeedById(id: number): Observable<Seed> {
    ...
    return <Observable<Seed>>(
      this.http.get(this.baseUrl + '/admin/seeds/id/' + id)
    );
  }
  ...
  deleteSeedById(id: number): Observable<Seed> {
    console.log('in service class');
    return <Observable<Seed>>(
      this.http.delete(this.baseUrl + '/admin/seeds/id/' + id)
    );
  }
  ...
  getAllSeedsLowToHigh(): Observable<Seed[]> {
    return <Observable<Seed[]>>(
      this.http.get(this.baseUrl + '/admin/seeds/costLowToHigh')
    );
  }

  getAllSeedsHighToLow(): Observable<Seed[]> {
    return <Observable<Seed[]>>(
      this.http.get(this.baseUrl + '/admin/seeds/costHighToLow')
    );
  }
}
